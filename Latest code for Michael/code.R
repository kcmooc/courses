...
yes <- read_csv("yes.csv")
# yes['Email']
yes_previous <- read_csv("yes_previous.csv")
# yes_previous['Email']
yes_diff_email <- setdiff(yes['Email'],yes_previous['Email'])
#yes_diff_email
yes_diff <- yes[(yes$Email %in% yes_diff_email$Email), ]

write_csv(yes_diff, "yes_diff.csv")
