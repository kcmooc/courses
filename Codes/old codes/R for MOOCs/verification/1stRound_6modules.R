...
m123456 <- merge(m12345, module6, by.x = "User.full.name", by.y = "User.full.name", all= TRUE)

all.user <- merge(grades, m123456, by.x = "User.full.name", by.y = "User.full.name", all= TRUE )

colnames(all.user) [11:16]<- c("Forum1", "Forum2","Forum3", "Forum4", "Forum5", "Forum6")
